...
(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === 'object' && typeof module === 'object') {
    ...
    var a = typeof exports === 'object' ? factory(require("jquery")) : factory(
        root["jQuery"]);
    for (var i in a) {
          ...
          value: function render($parent) {
            ...
            if (this.options && this.options.data) {
              jquery__WEBPACK_IMPORTED_MODULE_0___default.a.each(
                  this.options.data, function (k, v) {
                    $node.attr('data-' + k, v);
                  });
            }
...
// CONCATENATED MODULE: ./src/js/base/summernote-en-US.js
      ...
      external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend(
          external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote.lang,
          {
            'en-US': {
              font: {
                bold: 'Bold',
...
// CONCATENATED MODULE: ./src/js/base/core/env.js
      ...
      var genericFontFamilies = ['sans-serif', 'serif', 'monospace', 'cursive',
        'fantasy'];

      function validFontName(fontName) {
        return external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.inArray(
            fontName.toLowerCase(), genericFontFamilies) === -1 ? "'".concat(
            fontName, "'") : fontName;
      }
      ...
      function env_isFontInstalled(fontName) {
        ...
        context.font = testSize + ' ' + validFontName(fontName) + ', "'
            + testFontName + '"';
      ...
      var isSupportTouch = 'ontouchstart' in window || navigator.MaxTouchPoints
...
// - see: https://goo.gl/4bfIvA
      ...
      var env = ({
        ...
        isSafari: !isEdge && /safari/i.test(userAgent) && !/chrome/i.test(
            userAgent),
        browserVersion: browserVersion,
        jqueryVersion: parseFloat(
            external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.fn.jquery),
...
// CONCATENATED MODULE: ./src/js/base/core/dom.js
      ...
      function isControlSizing(node) {
        return node
            && external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                node).hasClass('note-control-sizing');
      }
      ...
      function dom_isInline(node) {
        return !isBodyContainer(node) && !isList(node) && !isHr(node)
            && !isPara(node) && !isTable(node) && !isBlockquote(node)
            && !isData(node);
      }
...
*/
      ...
      function isVisiblePoint(point) {
        if (isText(point.node) || !hasChildren(point.node) || dom_isEmpty(
            point.node)) {
          return true;
        }
        ...
        if ((!leftNode || isVoid(leftNode)) && (!rightNode || isVoid(
            rightNode))) {
          return true;
        }
      ...
      function dom_html($node, isNewlineOnBlock) {
        ...
        if (isNewlineOnBlock) {
          ...
          markup = markup.replace(regexTag, function (match, endSlash, name) {
            ...
            var isEndOfInlineContainer = /^DIV|^TD|^TH|^P|^LI|^H[1-7]/.test(
                name) && !!endSlash;
      ...
      var Context_Context = /*#__PURE__*/function () {
        ...
        function Context($note, options) {
          ...
          this.options = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend(
              true, {}, options); // init ui with options
        ...
        _createClass(Context, [{
          ...
          value: function _initialize() {
            ...
            this.options.id = func.uniqueId(
                external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.now()); // set default container for tooltips, popovers, and dialogs
            ...
            var modules = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend(
                ...
                external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote.plugins
          ...
          value: function triggerEvent() {
            ...
            var callback = this.options.callbacks[func.namespaceToCamel(
                namespace, 'on')];
          ...
          value: function invoke() {
            ...
            var methodName = hasSeparator ? lists.last(splits) : lists.head(
                splits);
...
// CONCATENATED MODULE: ./src/js/base/core/range.js
      ...
      function range_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          range_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
      ...
      function textRangeToPoint(textRange, isStart) {
        ...
        if (offset !== 0 && dom.isText(childNodes[offset - 1])) {
          ...
          if (isStart && curTextNode.nextSibling && dom.isText(
              curTextNode.nextSibling) && textCount
      ...
      var range_WrappedRange = /*#__PURE__*/function () {
        ...
        range_createClass(WrappedRange, [{
          ...
          value: function normalize() {
             ...
             * @return {BoundaryPoint}
             */
            var getVisiblePoint = function getVisiblePoint(point,
                isLeftToRight) {
              if (!point) {
                return point;
              ...
              if (dom.isVisiblePoint(point)) {
                if (!dom.isEdgePoint(point) || dom.isRightEdgePoint(point)
                    && !isLeftToRight || dom.isLeftEdgePoint(point)
                    && isLeftToRight || dom.isRightEdgePoint(point)
                    && isLeftToRight && dom.isVoid(point.node.nextSibling)
                    || dom.isLeftEdgePoint(point) && !isLeftToRight
                    && dom.isVoid(point.node.previousSibling) || dom.isBlock(
                        point.node) && dom.isEmpty(point.node)) {
                  return point;
                }
              ...
              if (!hasRightNode) {
                ...
                hasRightNode = (dom.isLeftEdgePointOf(point, block)
                    || dom.isVoid(prevPoint.node)) && !isLeftToRight;
              }
              ...
              var nextPoint = isLeftToRight ? dom.nextPointUntil(
                  dom.nextPoint(point), dom.isVisiblePoint)
                  : dom.prevPointUntil(dom.prevPoint(point),
                      dom.isVisiblePoint);
          ...
          value: function deleteContents() {
            ...
            external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(
                emptyParents, function (idx, node) {
                  dom.remove(node, false);
                });
          ...
          value: function wrapBodyInlineWithPara() {
            ...
            if (topAncestor) {
              ...
              inlineSiblings = inlineSiblings.concat(
                  dom.listNext(topAncestor.nextSibling, dom.isParaInline)); // wrap with paragraph
          ...
          value: function getWordsMatchRange(regex) {
            ...
            var startPoint = dom.prevPointUntil(endPoint, function (point) {
              ...
              var rng = new WrappedRange(point.node, point.offset,
                  endPoint.node, endPoint.offset);
              var result = regex.exec(rng.toString());
              return result && result.index === 0;
            });
            var rng = new WrappedRange(startPoint.node, startPoint.offset,
                endPoint.node, endPoint.offset);
      ...
      var range = ({
        ...
        createFromBodyElement: function createFromBodyElement(bodyElement) {
          var isCollapseToStart = arguments.length > 1 && arguments[1]
        ...
        createFromSelection: function createFromSelection() {
          ...
          if (env.isW3CRangeSupport) {
            ...
            if (dom.isText(startPoint.node) && dom.isLeftEdgePoint(startPoint)
                && dom.isTextNode(endPoint.node) && dom.isRightEdgePoint(
                    endPoint) && endPoint.node.nextSibling
                === startPoint.node) {
              startPoint = endPoint;
            }
         ...
         * @return {WrappedRange}
         */
        createFromParaBookmark: function createFromParaBookmark(bookmark,
            paras) {
          var so = bookmark.s.offset;
          var eo = bookmark.e.offset;
      ...
      var core_key = ({
        ...
        isEdit: function isEdit(keyCode) {
          return lists.contains(
              [KEY_MAP.BACKSPACE, KEY_MAP.TAB, KEY_MAP.ENTER, KEY_MAP.SPACE,
                KEY_MAP.DELETE], keyCode);
        },
        ...
        isMove: function isMove(keyCode) {
          return lists.contains(
              [KEY_MAP.LEFT, KEY_MAP.UP, KEY_MAP.RIGHT, KEY_MAP.DOWN], keyCode);
        },
...
// CONCATENATED MODULE: ./src/js/base/editing/History.js
      ...
      function History_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          History_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
...
// CONCATENATED MODULE: ./src/js/base/editing/Style.js
      ...
      function Style_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          Style_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
        ...
        Style_createClass(Style, [{
          ...
          value: function jQueryCSS($obj, propertyNames) {
            if (env.jqueryVersion < 1.9) {
              var result = {};
              external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(
                  propertyNames, function (idx, propertyName) {
          ...
          value: function styleNodes(rng, options) {
            ...
            var expandClosestSibling = !!(options
                && options.expandClosestSibling);
            var onlyPartialContains = !!(options
                && options.onlyPartialContains);
          ...
          value: function current(rng) {
            ...
            try {
              styleInfo = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend(
                  styleInfo, {
                    'font-bold': document.queryCommandState('bold') ? 'bold'
                        : 'normal',
                    ...
                    'font-superscript': document.queryCommandState(
                        'superscript') ? 'superscript' : 'normal',
                    'font-strikethrough': document.queryCommandState(
                        'strikethrough') ? 'strikethrough' : 'normal',
            ...
            if (!rng.isOnList()) {
              ...
              var orderedTypes = ['circle', 'disc', 'disc-leading-zero',
                'square'];
              var isUnordered = orderedTypes.indexOf(
                  styleInfo['list-style-type']) > -1;
            ...
            if (para && para.style['line-height']) {
              ...
              var lineHeight = parseInt(styleInfo['line-height'], 10)
                  / parseInt(styleInfo['font-size'], 10);
              styleInfo['line-height'] = lineHeight.toFixed(1);
            }

            styleInfo.anchor = rng.isOnAnchor() && dom.ancestor(rng.sc,
                dom.isAnchor);
...
// CONCATENATED MODULE: ./src/js/base/editing/Bullet.js
      ...
      function Bullet_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          Bullet_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
        ...
        Bullet_createClass(Bullet, [{
          ...
          value: function toggleList(listName, editable) {
            ...
            if (lists.find(paras, dom.isPurePara)) {
              ...
              if (diffLists.length) {
                external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(
                    diffLists, function (idx, listNode) {
          ...
          value: function wrapList(paras, listName) {
            ...
            var listNode = prevList || dom.insertAfter(
                dom.create(listName || 'UL'), last); // P to LI
                ...
                clustereds, function (idx, paras) {
                  ...
                  if (headList.parentNode.nodeName === 'LI') {
                    ...
                    paras = isEscapseToBody ? dom.listDescendant(middleList,
                        dom.isLi) : lists.from(middleList.childNodes).filter(
                        dom.isLi); // LI to P
                    ...
                    external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(
                        lists.from(paras).reverse(), function (idx, para) {
                          dom.insertAfter(para, headList);
                        }); // remove empty lists

                    var rootLists = lists.compact(
                        [headList, middleList, lastList]);
                    external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(
                        rootLists, function (idx, rootList) {
                          var listNodes = [rootList].concat(
                              dom.listDescendant(rootList, dom.isList));
                          external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(
                              listNodes.reverse(), function (idx, listNode) {
          ...
          value: function appendToPrevious(node) {
            return node.previousSibling ? dom.appendChildNodes(
                node.previousSibling, [node]) : this.wrapList([node], 'LI');
          }
          /**
           * @method findList
           *
...
// CONCATENATED MODULE: ./src/js/base/editing/Typing.js
      ...
      function Typing_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          Typing_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
        ...
        Typing_createClass(Typing, [{
          ...
          value: function insertParagraph(editable, rng) {
            ...
            if (splitRoot) {
              ...
              if (dom.isLi(splitRoot) && (dom.isEmpty(splitRoot)
                ...
                if (blockquote) {
                  ...
                  nextPara = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                      dom.emptyPara)[0]; // If the split is right before a <br>, remove it so that there's no "empty line"
                  ...
                  external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(
                      emptyAnchors, function (idx, anchor) {
                        dom.remove(anchor);
                      }); // replace empty heading, pre or custom-made styleTag with P tag

                  if ((dom.isHeading(nextPara) || dom.isPre(nextPara)
                      || dom.isCustomStyleTag(nextPara)) && dom.isEmpty(
                      nextPara)) {
...
// CONCATENATED MODULE: ./src/js/base/editing/Table.js
      ...
      function Table_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          Table_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
      ...
      var TableResultAction = function TableResultAction(startPoint, where,
          action, domTable) {
        var _startPoint = {
          'colPos': 0,
          'rowPos': 0
        ...
        function addCellInfoToVirtual(row, cell) {
          ...
          setVirtualTablePosition(row.rowIndex, cellIndex, row, cell,
              cellHasRowspan, cellHasColspan, false); // Add span rows to virtual Table.
          ...
          if (rowspanNumber > 1) {
            for (var rp = 1; rp < rowspanNumber; rp++) {
              ...
              adjustStartPoint(rowspanIndex, cellIndex, cell,
                  isThisSelectedCell);
          ...
          if (colspanNumber > 1) {
            for (var cp = 1; cp < colspanNumber; cp++) {
              var cellspanIndex = recoverCellIndex(row.rowIndex,
                  cellIndex + cp);
        ...
        function adjustStartPoint(rowIndex, cellIndex, cell, isSelectedCell) {
          if (rowIndex === _startPoint.rowPos && _startPoint.colPos
              >= cell.cellIndex && cell.cellIndex <= cellIndex
              && !isSelectedCell) {
            _startPoint.colPos++;
          }
        }
      ...
      var Table_Table = /*#__PURE__*/function () {
        ...
        Table_createClass(Table, [{
            ...
            for (var idCell = 0; idCell < actions.length; idCell++) {
              ...
              switch (currentCell.action) {
                ...
                case TableResultAction.resultAction.SumSpanCount: {
                  ...
                  var rowspanNumber = parseInt(currentCell.baseCell.rowSpan,
                      10);
                  rowspanNumber++;
          ...
          value: function addCol(rng, position) {
            ...
            for (var actionIndex = 0; actionIndex < actions.length;
                actionIndex++) {
    ...
    */
          ...
          value: function deleteRow(rng) {
            ...
            var row = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                cell).closest('tr');
            var cellPos = row.children('td, th').index(
                external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                    cell));
            ...
            for (var actionIndex = 0; actionIndex < actions.length;
              ...
              var rowspanNumber = hasRowspan ? parseInt(baseCell.rowSpan, 10)
                  : 0;
                ...
                case TableResultAction.resultAction.SubtractSpanCount:
                  if (hasRowspan) {
                    if (rowspanNumber > 2) {
                      ...
                      if (virtualPosition.rowIndex !== rowPos
...
// CONCATENATED MODULE: ./src/js/base/module/Editor.js
      ...
      function Editor_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          Editor_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
      ...
      var Editor_Editor = /*#__PURE__*/function () {
        function Editor(context) {
          ...
          this.context.memo('help.insertParagraph',
          ...
          var commands = ['bold', 'italic', 'underline', 'strikethrough',
            ...
            'justifyRight', 'justifyFull', 'formatBlock', 'removeFormat',
            'backColor'];
          ...
          for (var _idx = 1; _idx <= 6; _idx++) {
            ...
            this.context.memo('help.formatH' + _idx,
          ...
          this.createLink = this.wrapCommand(function (linkInfo) {
            ...
            if (additionalTextLength > 0 && _this.isLimited(
          ...
          this.insertTable = this.wrapCommand(function (dim) {
            ...
            rng.insertNode(_this.table.createTable(dimension[0], dimension[1],
                _this.options));
          });
          /**
          ...
          this.removeMedia = this.wrapCommand(function () {
            var $target = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                _this.restoreTarget()).parent();

            if ($target.closest('figure').length) {
              $target.closest('figure').remove();
            } else {
              $target = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                  _this.restoreTarget()).detach();
            }

            _this.context.triggerEvent('media.delete', $target,
                _this.$editable);
          });
          /**
           * float me
        ...
        Editor_createClass(Editor, [{
          ...
          value: function initialize() {
            ...
            this.$editable.on(env.inputEventName, func.debounce(function () {
              _this2.context.triggerEvent('change', _this2.$editable.html(),
                  _this2.$editable);
            }, 10));
          ...
          value: function preventDefaultEditableShortCuts(event) {
            ...
            if ((event.ctrlKey || event.metaKey) && lists.contains([66, 73, 85],
                event.keyCode)) {
              event.preventDefault();
            }
          }
          ...
          value: function isLimited(pad, event) {
            ...
            if (typeof event !== 'undefined') {
              if (core_key.isMove(event.keyCode) || core_key.isNavigation(
                  event.keyCode) || event.ctrlKey || event.metaKey
                  || lists.contains(
          ...
          value: function createRangeFromList(lst) {
            ...
            return range.create(startPoint.node, startPoint.offset,
                endPoint.node, endPoint.offset);
          }
          /**
           * set the last range
          ...
          value: function setLastRange(rng) {
            if (rng) {
              ...
              if (external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                  this.lastRange.sc).closest('.note-editable').length === 0) {
    ...
    */
          ...
          value: function beforeCommand() {
            ...
            document.execCommand('styleWithCSS', false,
                this.options.styleWithCSS); // keep focus on editable before command execution
          ...
          value: function onFormatBlock(tagName, $target) {
            ...
            document.execCommand('FormatBlock', false,
                env.isMSIE ? '<' + tagName + '>' : tagName); // support custom class
          ...
          value: function fontStyling(target, value) {
            ...
            if (rng !== '') {
              ...
              external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                  spans).css(target, value); // [workaround] added styled bogus span for style
              ...
              this.$editor.find('.note-status-output').html(
                  '<div id="note-status-output-' + noteStatusOutput
                  + '" class="alert alert-info">' + this.lang.output.noSelection
                  + '</div>');
              setTimeout(function () {
                external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
...
// CONCATENATED MODULE: ./src/js/base/module/Clipboard.js
      ...
      function Clipboard_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          Clipboard_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
...
// CONCATENATED MODULE: ./src/js/base/module/Dropzone.js
      ...
      function Dropzone_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          Dropzone_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
        ...
        function Dropzone(context) {
          ...
          this.$dropzone = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
              ['<div class="note-dropzone">',
                '<div class="note-dropzone-message"></div>', '</div>'].join(
        ...
        Dropzone_createClass(Dropzone, [{
          ...
          value: function attachDragAndDropEvent() {
            ...
            this.documentEventHandlers.onDragenter = function (e) {
              ...
              var hasEditorSize = _this.$editor.width() > 0
            ...
            this.$eventListener.on('dragenter',
                this.documentEventHandlers.onDragenter).on('dragleave',
                this.documentEventHandlers.onDragleave).on('drop',
            ...
            this.$dropzone.on('drop', function (event) {
              ...
              if (dataTransfer && dataTransfer.files
                ...
                external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(
                    dataTransfer.types, function (idx, type) {
          ...
          value: function destroy() {
            ...
            Object.keys(this.documentEventHandlers).forEach(function (key) {
              _this2.$eventListener.off(key.substr(2).toLowerCase(),
...
// CONCATENATED MODULE: ./src/js/base/module/Codeview.js
      ...
      function Codeview_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          Codeview_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
      ...
      var Codeview_CodeView = /*#__PURE__*/function () {
        ...
        Codeview_createClass(CodeView, [{
          ...
          value: function activate() {
            ...
            if (CodeMirror) {
              var cmEditor = CodeMirror.fromTextArea(this.$codable[0],
                  this.options.codemirror); // CodeMirror TernServer
              ...
              cmEditor.on('change', function () {
                _this2.context.triggerEvent('change.codeview',
              ...
              this.$codable.on('input', function () {
                _this2.context.triggerEvent('change.codeview',
                    _this2.$codable.val(), _this2.$codable);
              });
            }
          }
          /**
...
// CONCATENATED MODULE: ./src/js/base/module/Statusbar.js
      ...
      function Statusbar_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          Statusbar_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
...
// CONCATENATED MODULE: ./src/js/base/module/Fullscreen.js
      ...
      function Fullscreen_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          Fullscreen_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
...
// CONCATENATED MODULE: ./src/js/base/module/Handle.js
      ...
      function Handle_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          Handle_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
          ...
          value: function initialize() {
            ...
            this.$handle = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                ['<div class="note-handle">',
                  ...
                  this.options.disableResizeImage ? 'note-control-holder'
                      : 'note-control-sizing', ' note-control-se"></div>',
            ...
            this.$handle.on('mousedown', function (event) {
              if (dom.isControlSizing(event.target)) {
                ...
                var $target = _this2.$handle.find(
                    '.note-control-selection').data('target');
...
// CONCATENATED MODULE: ./src/js/base/module/AutoLink.js
      ...
      function AutoLink_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          AutoLink_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
...
// CONCATENATED MODULE: ./src/js/base/module/AutoSync.js
      ...
      function AutoSync_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          AutoSync_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
...
// CONCATENATED MODULE: ./src/js/base/module/AutoReplace.js
      ...
      function AutoReplace_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          AutoReplace_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
      ...
      var AutoReplace_AutoReplace = /*#__PURE__*/function () {
        function AutoReplace(context) {
          ...
          this.keys = [core_key.code.ENTER, core_key.code.SPACE,
            core_key.code.PERIOD, core_key.code.COMMA, core_key.code.SEMICOLON,
            core_key.code.SLASH];
...
// CONCATENATED MODULE: ./src/js/base/module/Placeholder.js
      ...
      function Placeholder_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          Placeholder_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
...
// CONCATENATED MODULE: ./src/js/base/module/Buttons.js
      ...
      function Buttons_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          Buttons_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
      ...
      var Buttons_Buttons = /*#__PURE__*/function () {
        ...
        Buttons_createClass(Buttons, [{
          ...
          value: function isFontInstalled(name) {
            if (!Object.prototype.hasOwnProperty.call(this.fontInstalledMap,
                name)) {
          ...
          key: "colorPalette",
          value: function colorPalette(className, tooltip, backColor,
              foreColor) {
            var _this = this;
            ...
            return this.ui.buttonGroup({
              ...
              children: [this.button({
                ...
                items: (backColor ? ['<div class="note-palette">',
                  ...
                  + this.lang.color.background + '</div>', '<div>',
                  ...
                  '</div>'].join('') : '') + (foreColor
                    ? ['<div class="note-palette">',
                      ...
                      + '" data-event="foreColorPalette">', '</div>', // Fix missing Div, Commented to find easily if it's wrong
                ...
                callback: function callback($dropdown) {
                  ...
                  $dropdown.find('.note-holder-custom').each(
                      function (idx, item) {
                        var $holder = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                            item);
                        $holder.append(_this.ui.palette({
                  ...
                  $dropdown.find('input[type=color]').each(
                      function (idx, item) {
                        external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                            item).change(function () {
                          var $chip = $dropdown.find('#'
                              + external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                                  this).data('event')).find(
                              '.note-color-btn').first();
                          var color = this.value.toUpperCase();
                          $chip.css('background-color', color).attr(
                              'aria-label', color).attr('data-value',
                              color).attr('data-original-title', color);
                          $chip.click();
                        });
                      });
                },
                  ...
                  if (eventName === 'openPalette') {
                    ...
                    var $palette = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                        $parent.find('#' + $picker.data('event')).find(
                            '.note-color-row')[0]); // Shift palette chips

                    var $chip = $palette.find(
                        '.note-color-btn').last().detach(); // Set chip attributes

                    var color = $picker.val();
                    $chip.css('background-color', color).attr('aria-label',
                        color).attr('data-value', color).attr(
          ...
          value: function addToolbarButtons() {
            ...
            this.context.memo('button.style', function () {
              return _this2.ui.buttonGroup([_this2.button({
                ...
                contents: _this2.ui.dropdownButtonContents(
                    _this2.ui.icon(_this2.options.icons.magic), _this2.options),
                  ...
                  if (typeof item === 'string') {
                    item = {
                      ...
                      title: Object.prototype.hasOwnProperty.call(
                          _this2.lang.style, item) ? _this2.lang.style[item]
                          : item
                    };
                  }
            ...
            this.context.memo('button.bold', function () {
              return _this2.button({
                ...
                tooltip: _this2.lang.font.bold + _this2.representShortcut(
                    'bold'),
            ...
            this.context.memo('button.italic', function () {
              return _this2.button({
                ...
                tooltip: _this2.lang.font.italic + _this2.representShortcut(
                    'italic'),
                click: _this2.context.createInvokeHandlerAndUpdateState(
                    'editor.italic')
              }).render();
            ...
            this.context.memo('button.underline', function () {
              return _this2.button({
                ...
                tooltip: _this2.lang.font.underline + _this2.representShortcut(
                    'underline'),
                click: _this2.context.createInvokeHandlerAndUpdateState(
                    'editor.underline')
              }).render();
            ...
            this.context.memo('button.clear', function () {
              return _this2.button({
                ...
                tooltip: _this2.lang.font.clear + _this2.representShortcut(
                    'removeFormat'),
            ...
            this.context.memo('button.color', function () {
              return _this2.colorPalette('note-color-all',
                  _this2.lang.color.recent, true, true);
            });
            this.context.memo('button.forecolor', function () {
              return _this2.colorPalette('note-color-fore',
                  _this2.lang.color.foreground, false, true);
            });
            this.context.memo('button.backcolor', function () {
              return _this2.colorPalette('note-color-back',
                  _this2.lang.color.background, true, false);
            });
            this.context.memo('button.ul', function () {
              return _this2.button({
                contents: _this2.ui.icon(_this2.options.icons.unorderedlist),
                tooltip: _this2.lang.lists.unordered + _this2.representShortcut(
                    'insertUnorderedList'),
                click: _this2.context.createInvokeHandler(
            ...
            this.context.memo('button.ol', function () {
              return _this2.button({
                ...
                tooltip: _this2.lang.lists.ordered + _this2.representShortcut(
                    'insertOrderedList'),
                click: _this2.context.createInvokeHandler(
            ...
            var indent = this.button({
              ...
              tooltip: this.lang.paragraph.indent + this.representShortcut(
                  'indent'),
            ...
            this.context.memo('button.table', function () {
              return _this2.ui.buttonGroup([_this2.button({
                className: 'dropdown-toggle',
                contents: _this2.ui.dropdownButtonContents(
                    _this2.ui.icon(_this2.options.icons.table), _this2.options),
                ...
                items: ['<div class="note-dimension-picker">',
                  ...
                  '</div>',
                  '<div class="note-dimension-display">1 x 1</div>'].join('')
              })], {
                callback: function callback($node) {
                  ...
                  }).mousedown(_this2.context.createInvokeHandler(
                      'editor.insertTable')).on('mousemove',
            ...
            this.context.memo('button.link', function () {
              return _this2.button({
                ...
                tooltip: _this2.lang.link.link + _this2.representShortcut(
                    'linkDialog.show'),
            ...
            this.context.memo('button.hr', function () {
              return _this2.button({
                ...
                tooltip: _this2.lang.hr.insert + _this2.representShortcut(
            ...
            this.context.memo('button.redo', function () {
              return _this2.button({
                ...
                tooltip: _this2.lang.history.redo + _this2.representShortcut(
                    'redo'),
            ...
            this.context.memo('button.undo', function () {
              return _this2.button({
                ...
                tooltip: _this2.lang.history.undo + _this2.representShortcut(
                    'undo'),
          ...
          value: function build($container, groups) {
            for (var groupIdx = 0, groupLen = groups.length;
                groupIdx < groupLen; groupIdx++) {
          ...
          value: function updateCurrentStyle($container) {
            ...
            if (styleInfo['font-family']) {
              ...
              var fontName = lists.find(fontNames,
              ...
              $cont.find('.dropdown-fontname a').each(function (idx, item) {
                var $item = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                    item); // always compare string to avoid creating another func.

                var isChecked = $item.data('value') + '' === fontName + '';
                $item.toggleClass('checked', isChecked);
              });
              $cont.find('.note-current-fontname').text(fontName).css(
            ...
            if (styleInfo['font-size']) {
              ...
              $cont.find('.dropdown-fontsize a').each(function (idx, item) {
                var $item = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                    item); // always compare with string to avoid creating another func.
            ...
            if (styleInfo['line-height']) {
              ...
              $cont.find('.dropdown-line-height li a').each(
                  function (idx, item) {
                    // always compare with string to avoid creating another func.
                    var isChecked = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                        item).data('value') + '' === lineHeight + '';
          ...
          value: function tableMoveHandler(event) {
            ...
            var $picker = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                event.target.parentNode); // target is mousecatcher
...
// CONCATENATED MODULE: ./src/js/base/module/Toolbar.js
      ...
      function Toolbar_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          Toolbar_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
      ...
      var Toolbar_Toolbar = /*#__PURE__*/function () {
        ...
        Toolbar_createClass(Toolbar, [{
          ...
          value: function followScroll() {
            ...
            } else if (this.isFollowing && (currentOffset < activateOffset
...
// CONCATENATED MODULE: ./src/js/base/module/LinkDialog.js
      ...
      function LinkDialog_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          LinkDialog_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
      ...
      var LinkDialog_LinkDialog = /*#__PURE__*/function () {
        ...
        LinkDialog_createClass(LinkDialog, [{
          key: "initialize",
          value: function initialize() {
            var $container = this.options.dialogsInBody ? this.$body
                : this.options.container;
            var body = ['<div class="form-group note-form-group">',
              "<label for=\"note-dialog-link-txt-".concat(this.options.id,
                  "\" class=\"note-form-label\">").concat(
                  this.lang.link.textToDisplay, "</label>"),
              ...
              '</div>', '<div class="form-group note-form-group">',
              "<label for=\"note-dialog-link-url-".concat(this.options.id,
                  "\" class=\"note-form-label\">").concat(this.lang.link.url,
                  "</label>"),
            ...
            var footer = "<input type=\"button\" href=\"#\" class=\"".concat(
                buttonClass, "\" value=\"").concat(this.lang.link.insert,
                "\" disabled>");
...
// CONCATENATED MODULE: ./src/js/base/module/LinkPopover.js
      ...
      function LinkPopover_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          LinkPopover_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
...
// CONCATENATED MODULE: ./src/js/base/module/ImageDialog.js
      ...
      function ImageDialog_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          ImageDialog_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
        ...
        ImageDialog_createClass(ImageDialog, [{
          ...
          value: function initialize() {
            ...
            if (this.options.maximumImageFileSize) {
              ...
              var readableSize = (this.options.maximumImageFileSize / Math.pow(
                  1024, unit)).toFixed(2) * 1 + ' ' + ' KMGTP'[unit] + 'B';
            ...
            var body = ['<div class="form-group note-form-group note-group-select-from-files">',
              '<label for="note-dialog-image-file-' + this.options.id
              + '" class="note-form-label">' + this.lang.image.selectFromFiles
              + '</label>',
              ...
              '<label for="note-dialog-image-url-' + this.options.id
              + '" class="note-form-label">' + this.lang.image.url + '</label>',
            ...
            var footer = "<input type=\"button\" href=\"#\" class=\"".concat(
                buttonClass, "\" value=\"").concat(this.lang.image.insert,
                "\" disabled>");
            this.$dialog = this.ui.dialog({
...
// CONCATENATED MODULE: ./src/js/base/module/ImagePopover.js
      ...
      function ImagePopover_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          ImagePopover_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
          ImagePopover_defineProperties(Constructor,
              staticProps);
        }
        return Constructor;
      }
...
// CONCATENATED MODULE: ./src/js/base/module/TablePopover.js
      ...
      function TablePopover_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          TablePopover_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
          TablePopover_defineProperties(Constructor,
              staticProps);
        }
        return Constructor;
      }
        ...
        TablePopover_createClass(TablePopover, [{
          ...
          value: function initialize() {
            ...
            var $content = this.$popover.find(
                '.popover-content,.note-popover-content');
            this.context.invoke('buttons.build', $content,
                this.options.popover.table); // [workaround] Disable Firefox's default table editor
...
// CONCATENATED MODULE: ./src/js/base/module/VideoDialog.js
      ...
      function VideoDialog_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          VideoDialog_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
        ...
        VideoDialog_createClass(VideoDialog, [{
          ...
          value: function initialize() {
            ...
            var body = ['<div class="form-group note-form-group row-fluid">',
              "<label for=\"note-dialog-video-url-".concat(this.options.id,
                  "\" class=\"note-form-label\">").concat(this.lang.video.url,
                  " <small class=\"text-muted\">").concat(
                  this.lang.video.providers, "</small></label>"),
            ...
            var footer = "<input type=\"button\" href=\"#\" class=\"".concat(
                buttonClass, "\" value=\"").concat(this.lang.video.insert,
                "\" disabled>");
            this.$dialog = this.ui.dialog({
          ...
          value: function createVideoNode(url) {
            ...
            if (ytMatch && ytMatch[1].length === 11) {
              ...
              $video = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                  ...
                  '//www.youtube.com/embed/' + youtubeId + (start > 0
                  ? '?start=' + start : '')).attr('width', '640').attr('height',
                  '360');
            } else if (igMatch && igMatch[0].length) {
              $video = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                  '<iframe>').attr('frameborder', 0).attr('src',
                  'https://instagram.com/p/' + igMatch[1] + '/embed/').attr(
                  'width', '612').attr('height', '710').attr('scrolling',
                  'no').attr('allowtransparency', 'true');
            } else if (vMatch && vMatch[0].length) {
              $video = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                  '<iframe>').attr('frameborder', 0).attr('src',
                  vMatch[0] + '/embed/simple').attr('width', '600').attr(
                  'height', '600').attr('class', 'vine-embed');
            } else if (vimMatch && vimMatch[3].length) {
              $video = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                  '<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>').attr(
                  'frameborder', 0).attr('src',
                  '//player.vimeo.com/video/' + vimMatch[3]).attr('width',
                  '640').attr('height', '360');
            } else if (dmMatch && dmMatch[2].length) {
              $video = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                  '<iframe>').attr('frameborder', 0).attr('src',
                  '//www.dailymotion.com/embed/video/' + dmMatch[2]).attr(
                  'width', '640').attr('height', '360');
            } else if (youkuMatch && youkuMatch[1].length) {
              $video = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                  '<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>').attr(
                  'frameborder', 0).attr('height', '498').attr('width',
                  '510').attr('src',
              ...
              $video = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                  '<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>').attr(
                  'frameborder', 0).attr('height', '310').attr('width',
                  '500').attr('src',
                  'https://v.qq.com/txp/iframe/player.html?vid=' + vid
                  + '&amp;auto=0');
            } else if (mp4Match || oggMatch || webmMatch) {
              $video = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                  '<video controls>').attr('src', url).attr('width',
                  '640').attr('height', '360');
              ...
              $video = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                  ...
                  + '&show_text=0&width=560').attr('width', '560').attr(
                  'height', '301').attr('scrolling', 'no').attr(
...
// CONCATENATED MODULE: ./src/js/base/module/HelpDialog.js
      ...
      function HelpDialog_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          HelpDialog_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
...
// CONCATENATED MODULE: ./src/js/base/module/AirPopover.js
      ...
      function AirPopover_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          AirPopover_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
      ...
      var AirPopover_AirPopover = /*#__PURE__*/function () {
        function AirPopover(context) {
          ...
          this.events = {
            ...
            'summernote.keyup summernote.mouseup summernote.scroll': function summernoteKeyupSummernoteMouseupSummernoteScroll(we,
                e) {
        ...
        AirPopover_createClass(AirPopover, [{
          key: "shouldInitialize",
          value: function shouldInitialize() {
            return this.options.airMode && !lists.isEmpty(
          ...
          value: function initialize() {
            ...
            this.context.invoke('buttons.build', $content,
                this.options.popover.air); // disable hiding this popover preemptively by 'summernote.blur' event.
...
// CONCATENATED MODULE: ./src/js/base/module/HintPopover.js
      ...
      function HintPopover_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          HintPopover_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
        ...
        HintPopover_createClass(HintPopover, [{
          ...
          value: function replace() {
            ...
            if ($item.length) {
              ...
              if (this.matchingWord !== null && this.matchingWord.length
                  === 0) {
                this.lastWordRange.so = this.lastWordRange.eo; // Else si > 0 and normal case -> adjust range "before" for correct position of insertion
              } else if (this.matchingWord !== null && this.matchingWord.length
                  > 0 && !this.lastWordRange.isCollapsed()) {
                var rangeCompute = this.lastWordRange.eo - this.lastWordRange.so
              ...
              if (this.hints.length && keyword) {
                ...
                if (bnd) {
                  ...
                  this.hints.forEach(function (hint, idx) {
                    if (hint.match.test(keyword)) {
                      _this4.createGroup(idx, keyword).appendTo(
                          _this4.$content);
                    }
                  }); // select first .note-hint-item

                  this.$content.find('.note-hint-item:first').addClass(
                      'active'); // set position for popover after group is created
      ...
      external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend(
          external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote,
          {
            ...
            options: {
              ...
              colors: [['#000000', '#424242', '#636363', '#9C9C94', '#CEC6CE',
              ...
              colorsName: [['Black', 'Tundora', 'Dove Gray', 'Star Dust',
                'Pale Slate', 'Gallery', 'Alabaster', 'White'],
                ['Red', 'Orange Peel', 'Yellow', 'Green', 'Cyan', 'Blue',
                  'Electric Violet', 'Magenta'],
                ['Azalea', 'Karry', 'Egg White', 'Zanah', 'Botticelli',
                  'Tropical Blue', 'Mischka', 'Twilight'],
                ['Tonys Pink', 'Peach Orange', 'Cream Brulee', 'Sprout',
                  'Casper', 'Perano', 'Cold Purple', 'Careys Pink'],
                ['Mandy', 'Rajah', 'Dandelion', 'Olivine', 'Gulf Stream',
                  'Viking', 'Blue Marguerite', 'Puce'],
                ['Guardsman Red', 'Fire Bush', 'Golden Dream',
                  'Chelsea Cucumber', 'Smalt Blue', 'Boston Blue',
              ...
              codeviewIframeWhitelistSrcBase: ['www.youtube.com',
                'www.youtube-nocookie.com', 'www.facebook.com', 'vine.co',
                'instagram.com', 'player.vimeo.com', 'www.dailymotion.com',
      ...
      var TooltipUI_TooltipUI = /*#__PURE__*/function () {
        function TooltipUI($node, options) {
          ...
          this.$tooltip = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
              ['<div class="note-tooltip">',
                ...
                '<div class="note-tooltip-content"></div>', '</div>'].join('')); // define event
        ...
        _createClass(TooltipUI, [{
          ...
          value: function show() {
            ...
            var targetOffset = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
...
// CONCATENATED MODULE: ./src/js/lite/ui/DropdownUI.js
      ...
      function DropdownUI_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          DropdownUI_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
      ...
      var DropdownUI_DropdownUI = /*#__PURE__*/function () {
        ...
        DropdownUI_createClass(DropdownUI, [{
          ...
          value: function show() {
            ...
            var windowWidth = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                window).width();
      ...
      external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
        ...
        if (!external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
            e.target).closest('.note-btn-group').length) {
          external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
      ...
      external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
        ...
        external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
            e.target).closest('.note-dropdown-menu').parent().removeClass(
            'open');
        external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
            e.target).closest('.note-dropdown-menu').parent().find(
...
// CONCATENATED MODULE: ./src/js/lite/ui/ModalUI.js
      ...
      function ModalUI_createClass(Constructor, protoProps, staticProps) {
        if (protoProps) {
          ModalUI_defineProperties(Constructor.prototype,
              protoProps);
        }
        if (staticProps) {
...
// CONCATENATED MODULE: ./src/js/lite/ui.js
      ...
      var statusbar = renderer["a" /* default */].create(
          ['<output class="note-status-output" role="status" aria-live="polite"></output>',
            ...
            '<div class="note-icon-bar"></div>',
            '<div class="note-icon-bar"></div>', '</div>', '</div>'].join(''));
      ...
      var airEditable = renderer["a" /* default */].create(
          ['<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true"></div>',
            '<output class="note-status-output" role="status" aria-live="polite"></output>'].join(
              ''));
      ...
      var dropdown = renderer["a" /* default */].create(
          ...
          function ($node, options) {
            var markup = Array.isArray(options.items) ? options.items.map(
                function (item) {
                  ...
                  var content = options.template ? options.template(item)
                      : item;
                  var $temp = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                      '<a class="note-dropdown-item" href="#" data-value="'
                      + value + '" role="listitem" aria-label="' + value
                      + '"></a>');
            ...
            $node.on('click', '> .note-dropdown-item', function (e) {
              var $a = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                  this);
          ...
          function ($node, options) {
            var markup = Array.isArray(options.items) ? options.items.map(
                function (item) {
                  ...
                  var $temp = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                      '<a class="note-dropdown-item" href="#" data-value="'
                      + value + '" role="listitem" aria-label="' + item
                      + '"></a>');
      ...
      var tableDropdownButton = function tableDropdownButton(opt) {
        return buttonGroup([ui_button({
          ...
          items: ['<div class="note-dimension-picker">',
            '<div class="note-dimension-picker-mousecatcher" data-event="insertTable" data-value="1x1"></div>',
            '<div class="note-dimension-picker-highlighted"></div>',
            '<div class="note-dimension-picker-unhighlighted"></div>', '</div>',
            '<div class="note-dimension-display">1 x 1</div>'].join('')
        })], {
          callback: function callback($node) {
      ...
      var palette = renderer["a" /* default */].create(
          '<div class="note-color-palette"/>', function ($node, options) {
            var contents = [];
              ...
              for (var col = 0, colSize = colors.length; col < colSize; col++) {
                ...
                buttons.push(
                    ['<button type="button" class="note-btn note-color-btn"',
                      'style="background-color:', color, '" ', 'data-event="',
                      eventName, '" ', 'data-value="', color, '" ',
                      'data-title="', colorName, '" ', 'aria-label="',
                      colorName, '" ',
            ...
            $node.find('.note-color-btn').each(function () {
              external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                  this).data('_lite_tooltip', new ui_TooltipUI(
                  external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                      this), {
                    container: options.container
                  }));
        ...
        return buttonGroup({
          ...
          children: [ui_button({
            ...
            items: ['<div>',
              ...
              opt.lang.color.transparent, '</button>', '</div>',
              ...
              opt.lang.color.cpSelect, '</button>', '</div>', '</div>',
              ...
              opt.lang.color.resetToDefault, '</button>', '</div>',
      ...
      var dialog = renderer["a" /* default */].create(
          ...
          function ($node, options) {
            ...
            $node.html(['<div class="note-modal-content">', options.title
      ...
      var videoDialog = function videoDialog(opt) {
        var body = '<div class="note-form-group">'
            + '<label for="note-dialog-video-url-' + opt.id
            + '" class="note-form-label">' + opt.lang.video.url
            + ' <small class="text-muted">' + opt.lang.video.providers
            + '</small></label>' + '<input id="note-dialog-video-url-' + opt.id
            + '" class="note-video-url note-input" type="text"/>' + '</div>';
        var footer = ['<button type="button" href="#" class="note-btn note-btn-primary note-video-btn disabled" disabled>',
          opt.lang.video.insert, '</button>'].join('');
        return dialog({
      ...
      var imageDialog = function imageDialog(opt) {
        var body = '<div class="note-form-group note-group-select-from-files">'
            + '<label for="note-dialog-image-file-' + opt.id
            + '" class="note-form-label">' + opt.lang.image.selectFromFiles
            + '</label>' + '<input id="note-dialog-image-file-' + opt.id
            + '" class="note-note-image-input note-input" type="file" name="files" accept="image/*" multiple="multiple"/>'
            + opt.imageLimitation + '</div>' + '<div class="note-form-group">'
            + '<label for="note-dialog-image-url-' + opt.id
            + '" class="note-form-label">' + opt.lang.image.url + '</label>'
            + '<input id="note-dialog-image-url-' + opt.id
            + '" class="note-image-url note-input" type="text"/>' + '</div>';
        var footer = ['<button href="#" type="button" class="note-btn note-btn-primary note-btn-large note-image-btn disabled" disabled>',
      ...
      var linkDialog = function linkDialog(opt) {
        var body = '<div class="note-form-group">'
            + '<label for="note-dialog-link-txt-' + opt.id
            + '" class="note-form-label">' + opt.lang.link.textToDisplay
            + '</label>' + '<input id="note-dialog-link-txt-' + opt.id
            + '" class="note-link-text note-input" type="text"/>' + '</div>'
            + '<div class="note-form-group">'
            + '<label for="note-dialog-link-url-' + opt.id
            + '" class="note-form-label">' + opt.lang.link.url + '</label>'
            + '<input id="note-dialog-link-url-' + opt.id
            + '" class="note-link-url note-input" type="text" value="http://"/>'
            + '</div>' + (!opt.disableLinkTarget
                ? '<div class="checkbox"><label for="note-dialog-link-nw-'
                + opt.id + '"><input id="note-dialog-link-nw-' + opt.id
                + '" type="checkbox" checked> ' + opt.lang.link.openInNewWindow
                + '</label></div>' : '')
            + '<div class="checkbox"><label for="note-dialog-link-up-' + opt.id
            + '"><input id="note-dialog-link-up-' + opt.id
            + '" type="checkbox" checked> ' + opt.lang.link.useProtocol
            + '</label></div>';
        var footer = ['<button href="#" type="button" class="note-btn note-btn-primary note-link-btn disabled" disabled>',
          opt.lang.link.insert, '</button>'].join('');
        return dialog({
          className: 'link-dialog',
      ...
      var ui_checkbox = renderer["a" /* default */].create(
          '<div class="checkbox"></div>', function ($node, options) {
            $node.html(
                ['<label' + (options.id ? ' for="note-' + options.id + '"' : '')
                + '>', '<input role="checkbox" type="checkbox"' + (options.id
                    ? ' id="note-' + options.id + '"' : ''),
                  options.checked ? ' checked' : '',
                  ' aria-checked="' + (options.checked ? 'true' : 'false')
                  + '"/>', options.text ? options.text : '', '</label>'].join(
                    ''));
          });
          ...
          createLayout: function createLayout($note) {
            var $editor = (editorOptions.airMode ? airEditor(
                ...
                : editorOptions.toolbarPosition === 'bottom' ? editor(
                    [editingArea([codable(), editable()]), toolbar(),
                      statusbar()]) : editor(
                    [toolbar(), editingArea([codable(), editable()]),
                      statusbar()])).render();
